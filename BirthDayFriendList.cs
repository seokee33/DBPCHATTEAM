...
namespace DBUI
{
    public partial class BirthDayFriendList : Form
    {
        ...
        { 
            ...
            List<UserInfo> users = DBManager.GetInstance().select_Friends("SELECT f.Seq, u.Seq, u.UID, u.Address, u.Birth, u.NickName, u.Image, f.Top From CHAT.Friends AS f JOIN CHAT.UserInfo AS u ON f.FriendID = u.Seq WHERE f.UserID = " + LoginUser.GetInstance().get_User().get_Seq() + ";");
